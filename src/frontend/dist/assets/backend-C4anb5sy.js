...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, p as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, q as lookupResultToBuffer, t as RequestStatusResponseStatus, U as UnknownError, w as RequestStatusDoneNoReplyErrorCode, x as RejectError, y as CertifiedRejectErrorCode, z as UNREACHABLE_ERROR, I as InputError, A as InvalidReadStateRequestErrorCode, B as ReadRequestType, D as Principal, G as IDL, H as MissingCanisterIdErrorCode, J as HttpAgent, K as encode, Q as QueryResponseStatus, O as UncertifiedRejectErrorCode, V as isV3ResponseBody, W as isV2ResponseBody, X as UncertifiedRejectUpdateErrorCode, Y as UnexpectedErrorCode, Z as decode, S as Subscribable, _ as pendingThenable, $ as resolveEnabled, s as shallowEqualObjects, a0 as resolveStaleTime, k as noop, a1 as environmentManager, a2 as isValidTimeout, a3 as timeUntilStale, a4 as timeoutManager, a5 as focusManager, a6 as fetchState, a7 as replaceData, n as notifyManager, r as reactExports, l as shouldThrowError, d as useQueryClient, a8 as useInternetIdentity, a9 as createActorWithConfig, aa as Record, ab as Opt, ac as Vec, ad as Variant, ae as Service, af as Func, ag as Nat, ah as Principal$1, ai as Text, aj as Nat8, ak as Float64, al as Bool, am as Null, an as Int } from "./index-DnwehUM6.js";
...
const RestaurantRatingSummary = Record({
  "restaurantId": RestaurantId,
...
Service({
  ...
  "addDeliveryAddress": Func([Address], [], []),
  "addMenuItem": Func([MenuItemInput], [MenuItemId], []),
  "addRestaurant": Func([RestaurantInput], [RestaurantId], []),
  "addReview": Func([AddReviewInput], [ReviewId], []),
  "addToCart": Func([AddToCartInput], [], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "assignRole": Func([Principal$1, UserRole], [], []),
  "clearCart": Func([], [], []),
  ...
  "getRestaurantRatingSummary": Func(
    [RestaurantId],
    [RestaurantRatingSummary],
    ["query"]
  ),
  "getRestaurantReviews": Func(
    [RestaurantId],
    [Vec(Review)],
    ["query"]
  ),
  ...
  "listMenuItems": Func([RestaurantId], [Vec(MenuItem)], ["query"]),
  "listRestaurants": Func([], [Vec(Restaurant)], ["query"]),
  "listUserOrders": Func([], [Vec(Order)], ["query"]),
  "placeOrder": Func([PlaceOrderInput], [OrderId], []),
  "removeDeliveryAddress": Func([Nat], [], []),
  "removeFromCart": Func([MenuItemId], [], []),
  "saveCallerUserProfile": Func([UserProfileInput], [], []),
  ...
  "toggleRestaurantStatus": Func([RestaurantId], [], []),
  "transform": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  ),
  "updateCartItem": Func([MenuItemId, Nat], [], []),
  "updateMenuItem": Func([MenuItemId, MenuItemInput], [], []),
  "updateOrderStatus": Func([OrderId, OrderStatus$1], [], []),
  "updateRestaurant": Func([RestaurantId, RestaurantInput], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const AddToCartInput2 = IDL2.Record({
    "name": IDL2.Text,
    "restaurantId": RestaurantId2,
    "quantity": IDL2.Nat,
    "price": IDL2.Nat,
  ...
  const Cart2 = IDL2.Record({ "userId": UserId2, "items": IDL2.Vec(CartItem2) });
  ...
  const RestaurantRatingSummary2 = IDL2.Record({
    "restaurantId": RestaurantId2,
  ...
  const RestaurantFilter2 = IDL2.Record({
  ...
  return IDL2.Service({
    ...
    "addDeliveryAddress": IDL2.Func([Address2], [], []),
    "addMenuItem": IDL2.Func([MenuItemInput2], [MenuItemId2], []),
    "addRestaurant": IDL2.Func([RestaurantInput2], [RestaurantId2], []),
    "addReview": IDL2.Func([AddReviewInput2], [ReviewId2], []),
    "addToCart": IDL2.Func([AddToCartInput2], [], []),
    ...
    "getRestaurantRatingSummary": IDL2.Func(
      [RestaurantId2],
      [RestaurantRatingSummary2],
      ["query"]
    ),
    "getRestaurantReviews": IDL2.Func(
      [RestaurantId2],
      [IDL2.Vec(Review2)],
      ["query"]
    ),
    ...
    "listMenuItems": IDL2.Func([RestaurantId2], [IDL2.Vec(MenuItem2)], ["query"]),
    "listRestaurants": IDL2.Func([], [IDL2.Vec(Restaurant2)], ["query"]),
    "listUserOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "placeOrder": IDL2.Func([PlaceOrderInput2], [OrderId2], []),
    "removeDeliveryAddress": IDL2.Func([IDL2.Nat], [], []),
    "removeFromCart": IDL2.Func([MenuItemId2], [], []),
    "saveCallerUserProfile": IDL2.Func([UserProfileInput2], [], []),
    ...
    "toggleRestaurantStatus": IDL2.Func([RestaurantId2], [], []),
    "transform": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "updateCartItem": IDL2.Func([MenuItemId2, IDL2.Nat], [], []),
    "updateMenuItem": IDL2.Func([MenuItemId2, MenuItemInput2], [], []),
    "updateOrderStatus": IDL2.Func([OrderId2, OrderStatus2], [], []),
    "updateRestaurant": IDL2.Func([RestaurantId2, RestaurantInput2], [], [])
  });
};
...
class Backend {
  ...
  async getRestaurantRatingSummary(arg0) {
    if (this.processError) {
      try {
  ...
  async getRestaurantReviews(arg0) {
    if (this.processError) {
      try {
  ...
  async removeDeliveryAddress(arg0) {
    if (this.processError) {
      try {
  ...
  async toggleRestaurantStatus(arg0) {
    if (this.processError) {
      try {
...
async function from_candid_MenuItem_n19(_uploadFile, _downloadFile, value) {
...
async function from_candid_Restaurant_n29(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n28(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n30(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    imageBlob: record_opt_to_undefined(await from_candid_opt_n21(_uploadFile, _downloadFile, value.imageBlob)),
    deliveryFee: value.deliveryFee,
...
function from_candid_variant_n27(_uploadFile, _downloadFile, value) {
  return "Delivered" in value ? "Delivered" : "Confirmed" in value ? "Confirmed" : "Placed" in value ? "Placed" : "Preparing" in value ? "Preparing" : "Cancelled" in value ? "Cancelled" : "OutForDelivery" in value ? "OutForDelivery" : value;
}
...
async function to_candid_MenuItemInput_n8(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
function to_candid_OrderStatus_n40(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n41(_uploadFile, _downloadFile, value);
}
function to_candid_RestaurantFilter_n38(_uploadFile, _downloadFile, value) {
  return to_candid_record_n39(_uploadFile, _downloadFile, value);
}
async function to_candid_RestaurantInput_n11(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n12(_uploadFile, _downloadFile, value) {
  return {
